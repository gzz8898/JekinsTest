...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    public void startOpenCamera() {
        ...
        if (cameraIntent.resolveActivity(getPackageManager()) != null) {
            ...
            File cameraFile =
                    PictureFileUtils.createCameraFile(this,
                            type,
                            outputCameraPath, config.suffixType);
            File path = new File(outputCameraPath);
            if (!path.exists()) {
                try {
                    System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaeeeeeeeee" + cameraFile.getAbsolutePath());
                    path.mkdirs();
            ...
            Uri imageUri = FileProvider7.getUriForFile24(this, cameraFile);
    ...
    private Uri parUri(File cameraFile) {
        ...
        imageUri = FileProvider7.getUriForFile(this, cameraFile);
